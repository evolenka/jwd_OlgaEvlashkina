...
class WriteToJSONTest {
	...
	void testWriteToJSON() throws DaoException, IOException, JSONException {
		...
		ItemOfCoffee item2 = new ItemOfCoffee(ground2, pack2);
		...
		String expected = "{\"coffee\":{\"title\":\"зерновой\",\"sort\":\"арабика\",\"trademark\":\"Lavazza\",\"roastDegree\":\"средняя\",\"pricePerKg\":70.5,\"netWeight\":500},\"packing\":{\"type\":\"пластиковая банка\",\"price\":5.5,\"volume\":0.5,\"weight\":10},\"totalPrice\":35.25,\"grossWeight\":510}{\"coffee\":{\"grindingDegree\":\"мелкий\",\"title\":\"молотый\",\"sort\":\"робуста\",\"trademark\":\"Jardin\",\"roastDegree\":\"темная\",\"pricePerKg\":38.0,\"netWeight\":500},\"packing\":{\"type\":\"пресованная пачка\",\"price\":3.75,\"volume\":0.5,\"weight\":3},\"totalPrice\":19.0,\"grossWeight\":503}";
