...
import by.jwd.task04repository.service.specification.impl.SortByNameSpecificationImpl;

@RunWith(JUnitPlatform.class)
@SelectPackages("test.jwd.task04repository.service")

class EllipseRepositorySortByNameTest {
	...
	void testSortByName(List<IEllipse> actual, List<IEllipse> expected) {
		Assertions.assertEquals(actual, expected);
	}

	static Stream<Arguments> dataProvider() throws ServiceException {

		SortSpecification<IEllipse> specification = new SortByNameSpecificationImpl<>();
