...
public class ReadAllScheduleTest {
	

	static Logger logger = LogManager.getLogger(ReadAllScheduleTest.class);
	...
	@Test(description = "readAll", groups = { "dao" })
	
	public void testReadAllSchedule() throws DaoException {
