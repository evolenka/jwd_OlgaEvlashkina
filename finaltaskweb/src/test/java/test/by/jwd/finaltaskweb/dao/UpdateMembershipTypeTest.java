...
public class UpdateMembershipTypeTest {
	
	static Logger logger = LogManager.getLogger(UpdateMembershipTypeTest.class);
	...
	@Test(description = "updateMembershipType")

	public void testUpdateMembershipType() throws DaoException {
...
List <MembershipType> expected = new ArrayList<>();
		...
		factory.getMembershipDao().updateType(type5);
		List<MembershipType> actual = factory.getMembershipDao().readAllTypes();
		assertEquals(actual, expected);
	}

				
	@Test(dependsOnMethods = "testUpdateMembershipType")

	public void testUpdateMembershipType2() throws DaoException {
