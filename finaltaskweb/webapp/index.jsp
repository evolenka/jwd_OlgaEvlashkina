...
<body>
	<div class=index>
		<nav class="navbar navbar-expand-md bg-secondary navbar-dark">
			...
			<div class="dropdown">
			<form method="post" action="action">
			<select id="language" name="language" size="3">
  ...
  <form action="myservlet.do" method="POST">
    <select name="myselect" id="myselect" onchange="this.form.submit()">
        ...
        <option value="4">Four</option>
				...
				<button type= button name = language value = "${language}" href='<c:out value="${main}"/>'> <fmt:message
					key="main" bundle="${ rb }" /></a>
		</nav>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-5">
					<blockquote class="blockquote blockquote-custom">
						<p>"Nobody cares if you can’t dance well. Just get up and
