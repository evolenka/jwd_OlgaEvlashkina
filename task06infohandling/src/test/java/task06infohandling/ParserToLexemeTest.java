...
public class ParserToLexemeTest {

	@DataProvider(name = "DataForParserToLexeme")
	public Object[][] createDataForParserToLexeme() {
		return new Object[][] { {
	...
	@Test(groups = { "infoHandler" }, dataProvider = "DataForParserToLexeme")
	public void testParserToLexeme(String text, String parsedText) {

		Handler parser = new ParserToLexeme(new ParserToWord(new ParserToSymbol(null)));
