...
public class ParserToSentenceTest {

	@DataProvider(name = "DataForParserToSentence")
	public Object[][] createDataForParserToSentence() {
		return new Object[][] { {
	...
	@Test(groups = { "infoHandler" }, dataProvider = "DataForParserToSentence")
	public void testParserToSentence(String text, String parsedText) {

		Handler parser = new ParserToSentence(new ParserToLexeme(new ParserToWord(new ParserToSymbol(null))));
